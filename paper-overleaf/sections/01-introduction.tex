...
\item[\textbf{C4}] \textbf{A decomposition of the mechanism, by ablation,
      and the boundary at which it stops.} The write-ahead pattern is
      ...
      is what makes an outcome detectable, and where the record survives it
      does so without the
      ...
      prevention is where the fsync cost lives, and where the record survives
      an operator can buy the first without the second (the supplementary
      material, \emph{What the barrier costs, at three measured points}).
\end{itemize}
