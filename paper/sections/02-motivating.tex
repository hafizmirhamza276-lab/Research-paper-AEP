...
and it is the behaviour we measure for B0. Across the crashed cells,
\todoitem{final B0 rate inserted at freeze} of executions ended this way.
...
\begin{table}[t]
\centering
\caption{The trilemma, as the four baselines instantiate it. A durable
write-ahead record is necessary (Trace 1, 2) and not sufficient (Trace 3); what
distinguishes AEP is an outcome class in which it can decline to decide.}
\label{tab:trilemma}
\small
\begin{tabular}{@{}lccc@{}}
\toprule
