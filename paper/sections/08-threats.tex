...
scope, and within it the effect replicated across \ReplicationSessions{}
further sessions at
[\ReplicationPreventedLow{},\,\ReplicationPreventedHigh{}] effects prevented,
...
recorded there with what closing them changed, one still open: one run that did
not complete.
...
We stopped at four sessions deliberately rather than for want of machine
time, and the class sweep is reported as a bound rather than as a test.
Two further sessions were collected far enough to establish that they could
