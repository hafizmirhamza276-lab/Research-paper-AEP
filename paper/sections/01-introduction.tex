...
\item[\textbf{C3}] \textbf{An evaluation under real process kills} across six
      ...
      five reported fault regimes --- every execution crashed, none
      crashed, Redis hard-killed before the acknowledgement, Redis killed
      after dispatch, and storage discarding writes while reporting
      success --- against five baseline
